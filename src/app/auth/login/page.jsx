...
export default function LoginPage() {
    ...
    return (
        <>
            <div className="flex items-center justify-center bg-gradient-to-br from-cyan-900 to-sky-900 relative overflow-hidden">
                            ...
                            >
                                ...
                                >
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        variants={itemVariants}
                                        className="flex items-center justify-center gap-2 py-2.5 px-4 border border-white/20 rounded-xl bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300"
                                    >
